/**
 * Логотип Steam (Wikimedia Commons). Товарный знак Valve — используется как
 * указатель на магазин, а не как наша марка.
 *
 * Взят цветной, а не одноцветный: кнопка ведёт наружу, и человек должен понять,
 * куда именно, раньше, чем дочитает подпись. Идентификатор градиента снабжён
 * префиксом — общие имена вроде «A» в разметке столкнулись бы с чужими.
 */
export function SteamIcon({ size = 18 }: { size?: number }) {
  return (
    <svg viewBox="0 0 64 64" width={size} height={size} aria-hidden="true" focusable="false">
      <defs>
        <linearGradient id="arena-steam-grad" x2="50%" x1="50%" y2="100%" y1="0%">
